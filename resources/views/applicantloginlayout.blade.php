    ...
    <body>
        ...
        <div class="flex-center position-ref full-height">
            ...
            <ul>
                ...
                <li><a href="http://admission.iutoic-dhaka.edu/international_students/offered_programmes">Offered Programs</a></li>
            ...
            <div class="navbar2">
            <ul>
                 <li><a href="">@if (session()->has ('myname'))
                 {{session()->get('myname')}}
                 @endif
                 </a></li>
                 

                <li><a href="/applicantdashboard">DashBoard</a></li>


                 <?php if(session()->get('paycheck')!=NULL) { ?>
                 <li><a href="/payment">Payment</a></li>
                <?php } 

                else { ?>
                    <li><a href="/applicantpayment">Payment</a></li>
                 <?php  } ?> </li>
                
                <li><a href="/status">Status</a></li>
                <li><a href="/applicantlogin">Logout</a></li>
